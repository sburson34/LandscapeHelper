module.exports = {
  preset: 'react-native',
  // Defensive against leaked react-native Animated.timing setTimeout
  // callbacks that don't drain in the jest mock environment — PianoHelper
  // #20 hit a 20-min CI stall this way. No-op when nothing leaks.
  forceExit: true,
